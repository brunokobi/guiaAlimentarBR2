      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={styles.titulo1}>
            ...
            alimentos in natura ou minimamente processados, óleos, gorduras, sal
            e açúcar contribuem para diversificar e tornar mais saborosa a
            alimentação sem torná-la nutricionalmente desbalanceada.
          </Text>

          <Image
            source={require("../../assets/oleo.jpg")}
            style={styles.logo1}
          />
