    ...
    <>
      <ScrollView>
        <View style={styles.container}>
          ...
          <Image
            source={require("../../assets/leite.jpg")}
            style={styles.logo1}
          />
